...
window.Lzsoft.Auth.sessionStorageSection = null;
...
window.Lzsoft.Auth.FromSessionStorage = function(sectionName) {};
window.Lzsoft.Auth.FromCookie = function(sectionName) {};
